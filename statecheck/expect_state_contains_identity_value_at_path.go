...
var _ StateCheck = expectStateContainsIdentityValueAtPath{}
...
func (e expectStateContainsIdentityValueAtPath) CheckState(ctx context.Context, req CheckStateRequest, resp *CheckStateResponse) {
...
func ExpectStateContainsIdentityValueAtPath(resourceAddress string, identityAttrPath, stateAttrPath tfjsonpath.Path) StateCheck {
