		...
		Steps: []r.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("wrong type: attribute type is float64 or int64, known value type is knownvalue.StringValue"),
			},
		},
	})
}
		...
		Steps: []r.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("wrong type: attribute type is list, or set, known value type is knownvalue.MapValue"),
			},
		},
	})
}
		...
		Steps: []r.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("wrong type: attribute type is map, or object, known value type is knownvalue.ListValue"),
			},
		},
	})
}
