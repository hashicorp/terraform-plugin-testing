...
func Test_SkipAbove_Prerelease_HigherCoreVersion(t *testing.T) { //nolint:paralleltest
	t.Parallel()
...
func Test_SkipAbove_Prerelease_HigherPrerelease(t *testing.T) { //nolint:paralleltest
	t.Parallel()
	...
	r.UnitTest(t, r.TestCase{
		...
		TerraformVersionChecks: []tfversion.TerraformVersionCheck{
			tfversion.SkipAbove(version.Must(version.NewVersion("1.7.0-rc2"))),
		},
		Steps: []r.TestStep{
			{
				Config: `//non-empty config`,
...
func Test_SkipAbove_Prerelease_LowerCoreVersion(t *testing.T) { //nolint:paralleltest
	t.Parallel()
...
func Test_SkipAbove_Prerelease_LowerPrerelease(t *testing.T) { //nolint:paralleltest
	t.Parallel()
	...
	r.UnitTest(t, r.TestCase{
		...
		TerraformVersionChecks: []tfversion.TerraformVersionCheck{
			tfversion.SkipAbove(version.Must(version.NewVersion("1.8.0-beta1"))),
		},
		Steps: []r.TestStep{
			{
				Config: `//non-empty config`,
