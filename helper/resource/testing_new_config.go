...
func testStepNewConfig(ctx context.Context, t hack.BaseT, c TestCase, wd *plugintest.WorkingDir, step TestStep, providers *providerFactories, stepIndex int, helper *plugintest.Helper) error {
	t.Helper()
