...
| [`statecheck.ExpectMatchValues(addressOne, pathOne, addressTwo, pathTwo)`](https://pkg.go.dev/github.com/hashicorp/terraform-plugin-testing/statecheck#ExpectMatchingValues) | Asserts the specified attributes at the given managed resources have matching values.                                                                                                    |
