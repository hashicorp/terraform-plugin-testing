...
* [TestStep.ConfigDirectory](/terraform/plugin/testing/acceptance-tests/configuration#teststep-configdirectory)
...
~> **Note**: `ExternalProviders` cannot be specified when using ConfigDirectory.
...
~> **Note**: `ExternalProviders` cannot be specified when using `ConfigFile`.
